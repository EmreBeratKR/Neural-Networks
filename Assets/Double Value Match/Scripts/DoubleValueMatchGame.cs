...
{
    public class DoubleValueMatchGame : MonoBehaviour, 
        IGeneticAlgorithmEnvironment
    {
        ...
        private List<DoubleValueMatchPlayer> m_Players;
        ...
        public void Initialize(GeneticAlgorithmParameters parameters)
        {
            ...
            dummy.SetValue(m_Value0, m_Value1);
        ...
        {
            return BasicGeneticAlgorithmBrain.New(2, 256);
        }
